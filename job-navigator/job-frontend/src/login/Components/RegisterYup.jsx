...
const Register = (props) => {
  ...
  const formSubmitHandler = (values, setSubmitting) => {
    setShowSpinner(true);
    axios
      .post(`https://job-portal-38uy.onrender.com/auth/register`, { ...values })
      .then((res) => {
      ...
      <Container>
        ...
        <Row className="mb-5">
          <Col
            ...
            md={6}
            sm={12}
            className={`${classes.formContainer} ${classes.registerBackground} p-5 m-auto shadow-sm rounded-lg`}
          >
            <Formik
